...
<body>
	<div id="addprog">
		<form action="accueil.php" method="post">		
			...
			<input type="submit" class="btnadd" value="ajouter programme" name="ajouterprogramme">
		</form>
	</div>
	<div id="deleteprog">
		<form>
			<label>Nom du programme a supprimer</label><br>
				...
				$bdd->listprog('','idp');
				?><br>
				<input type="submit" class="btndelete" value="supprimer programme" name="DeleteProg">
		</form>
	</div>
	<div id="setprog">
		<form action="accueil.php" method="post">		
			...
			?><br>
			<input  type="submit" class="btnset" value="modifier programme" name="modifprog">
		</form>
	</div>
	<div id="addscene">
		<form action="accueil.php" method="post">		
			...
			<input type="submit" class="btnadd" value="ajouter scene" name="ajouterscene">
		</form>
	</div>
	<div id="deletescene">
		<form>
			...
			<?php
				$bdd->listscene('','ids');
			?><br>
			<input type="submit" class="btndelete" value="supprimer scene" name="DeleteScene">
		</form>
	</div>
	<div id="setscene"></div>
